...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
      ...
      if(!empty($fname) && !empty($uname) && !empty($email) && !empty($p_no) && !empty($pas1) && !empty($pas2) && !empty($gender))
      {
        ...
        $query = "INSERT INTO dealers (fname, uname, email, p_no, pas1, pas2, gender) values('$fname', '$uname', '$email', '$p_no', '$pas1', '$pas2', '$gender')";
...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="dealer_register.css">
