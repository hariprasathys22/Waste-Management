...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
   ...
   $sql = "INSERT INTO b_c (quantity, uname, address) values('$quantity', '$uname', '$address') ";
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>SPILT - Customer</title>
        <link rel="shortcut icon" type="image" href="port.png">
        <link rel="stylesheet" href="both_cus.css">
...
#showcase{
    font-weight: bold;
        ...
        <form action="" name="b_c" method="POST">
        <header id="showcase">
            <h1>Bio and Non Bio-Degradable Waste </h1>
