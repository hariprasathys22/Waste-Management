...
.navbar ul li:hover::after{
    width: 100%;
        ...
        <header id="showcase">
            ...
            <p>What type of waste do you have?</p>
            <a href="weight.php" class="button">Bio-Degradable</a>
            <a href="non_bio_cust.php" class="button">Non Bio-Degradable</a>
            <a href="both_cus.php" class="button">Both Bio & Non-Bio</a>
          </header>
    </body>
    </html>
