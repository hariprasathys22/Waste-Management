...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
   ...
   $sql = "INSERT INTO d_bio (quantity, uname, address) values('$quantity', '$uname', '$address') ";
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>SPILT - Bio Waste</title>
        <link rel="shortcut icon" type="image" href="port.png">
        <link rel="stylesheet" href="dealer_weight.css">
...
#showcase{
    font-weight: bold;
        ...
        <form action="" name="d_bio" method="POST">
        <header id="showcase">
